---
description: Create new Agent Skills for GitHub Copilot from prompts or by duplicating this template. Use when asked to create, scaffold, or build a skill. Generates SKILL.md files with correct frontmatter, directory structure, and optional scripts, references,
---
