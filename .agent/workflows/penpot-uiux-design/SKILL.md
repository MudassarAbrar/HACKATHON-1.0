---
description: Create professional UI/UX designs in Penpot using MCP tools for web, mobile, or desktop apps. Build dashboards, forms, landing pages, design systems, and components, ensuring accessibility and platform best practices.
---
